...
$$
\frac{1+2+3+\cdots+n+n}{n+1}
=\frac{\frac{n(n+1)}{2}+n}{n+1}
=\frac{\frac{n^2+n}{2}+\frac{2n}{2}}{n+1}
=\frac{\frac{n^2+n+2n}{2}}{n+1}
=\frac{n^2+3n}{2(n+1)}
=\frac{n(n+3)}{2(n+1)}
$$
这里补充一下**等差数列**的求和公式为:
...
$$
1*\frac{1}{2n}+2*\frac{1}{2n}+3*\frac{1}{2n}+\cdots+n*\frac{1}{2n}+n*\frac{1}{2}\\
=\frac{1+2+3+\cdots+n+n^2}{2n}\\
=\frac{\frac{n(n+1)}{2}+n^2}{2n}=
\frac{\frac{n(n+1)}{2}+\frac{2n^2}{2}}{2n}\\ 
=\frac{\frac{n^2+n+2n^2}{2}}{2n}=
\frac{3n^2+n}{4n}=\frac{3n+1}{4}
$$
...
$$
1*\frac{1}{n+1}+1*\frac{1}{n+1}+\cdots+1*\frac{1}{n+1}+n*\frac{1}{n+1}\\
=\frac{n+n}{n+1}=\frac{2n}{n+1}=O(2)=O(1)
$$
